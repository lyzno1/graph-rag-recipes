...
class LLMGenerator:
    ...
    def build_prompt(self, reference: RecipeRecord, candidates: Sequence[RecipeRecord], user_input: str) -> str:
        parts = [
            "你是一名善于解释口味风格的智能厨房助手。",
            f"用户输入: {user_input}",
            "参考菜谱:",
    ...
    def generate(self, reference: RecipeRecord, candidates: Sequence[RecipeRecord], user_input: str) -> str:
